				...
				if(pg_num_rows ($result) == 0){
					...
					while($row = pg_fetch_assoc($result)){
						...
						<tr>
							...
							<td>
							    <a href="insertar.php?nik='.$row['nombredominio'].'?cod='.$row['coddominio'].'" title="Indicador" class="btn btn-success btn"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
						$no++;
